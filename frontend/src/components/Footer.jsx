...
const Footer = () => {
  ...
  return (
    <>
      <FooterLinksGrid />
      {/* Simplified bottom footer based on the screenshot */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              ...
              <Link to="/" className="text-white hover:text-gray-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 01.8 14.58a4.11 4.11 0 003.66 2.873 8.222 8.222 0 01-5.084 1.396 11.617 11.617 0 006.29 1.84" />
                </svg>
              </Link>
              <Link to="/" className="text-white hover:text-gray-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8 0-4.41 3.59-8 8-8 4.41 0 8 3.59 8 8 0 4.41-3.59 8-8 8zm-2-3.5v-7l6 3.5-6 3.5z" />
                </svg>
              </Link>
              <Link to="/" className="text-white hover:text-gray-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Legal links in a thin centered row */}
          <div className="py-4 border-t border-gray-600 flex flex-wrap justify-center text-sm text-gray-300">
            <div className="flex flex-wrap justify-center space-x-4 footer-legal-links">
              <Link to="/terms" className="hover:text-white">{t('footer.terms')}</Link>
              <Link to="/general-terms" className="hover:text-white">{t('footer.generalTerms')}</Link>
              ...
              <Link to="/imprint" className="hover:text-white">{t('footer.imprint', 'Imprint')}</Link>
            </div>
            <div className="w-full text-center mt-4">
              <p className="text-gray-400">{t('footer.copyright', `© ${year} iMagenWiz. All rights reserved.`)}</p>
            </div>
          </div>
        </div>
      </footer>
