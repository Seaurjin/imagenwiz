...
# Enhanced script to run both Express and Flask backends with proper environment variables
...
echo "⚠️ Migrations: ${SKIP_MIGRATIONS}"
echo "======================================================"
...
if ! curl -s http://localhost:5000/api/health > /dev/null; then
  echo "⚠️ Flask backend might still be initializing. Express will retry connections."
fi
